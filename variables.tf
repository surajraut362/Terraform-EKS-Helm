...
variable "test1_subnet_az" {
  type        = string
  description = "Availability Zone of the subnet 1."
  default     = "  us-west-2a"
}

variable "test2_subnet_az" {
  type        = string
  description = "Availability zone of subnet 2."
  default     = "  us-west-2b"
}

variable "test1_subnet_cidr_block" {
  type        = string
  description = "CIDR block of subnet 1 to create."
  default     = "10.0.1.0/24"
}

variable "test2_subnet_cidr_block" {
  type        = string
  description = "CIDR block of subnet 1 to create."
  default     = "10.0.2.0/24"
}

variable "test1_subnet_nic_private_ip" {
  type        = list(string)
  description = "CIDR block of subnet 1 to create."
  default     = ["10.0.1.50"]
}
